    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnLogin.setOnClickListener {
            ...
            if (email.isEmpty()) {
                ...
                if (emailLayout != null) emailLayout.error = "Invalid email" else editEmail.error = "Invalid email"
                hasError = true
            }
            if (password.isEmpty()) {
                ...
                if (passwordLayout != null) passwordLayout.error = "At least 6 characters" else editPassword.error = "At least 6 characters"
                hasError = true
            }
